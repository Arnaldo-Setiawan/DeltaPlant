...
const VEHICLES = [
    { id: "vehicle_tank", color: '#ffffff', type: 'image', iconUrl: 'https://static.wikia.nocookie.net/delta-force/images/9/9d/Tank.png/revision/latest/scale-to-width-down/180?cb=20250215045840' }, 
...
const TEXT_HIT_AREA = 10; // Hit area buffer for text boxes

// --- NEW: Image Cache ---
const utilityImageCache = {};

// == HISTORY STATE (UNDO/REDO) ==
// History now stores objects: { lineData: string, icons: Array, textData: Array }
let history = [];
let historyIndex = -1;
...
let planningData = {}; // { map_sector_key: { sequenceId: { icons: [], lineData: 'base64', textData: [] } } }
...
let placedText = []; // NEW ALIAS: points to planningData[currentMapKey][currentSequenceId].textData
...
let movingType = null; // 'icon' or 'text'
let currentTool = 'pen';
...
let defaultText = 'LABEL'; // NEW: Default text label
...
const placementHintText = document.getElementById('placement-hint-text'); // NEW
const textInput = document.getElementById('text-input'); // NEW
...
// == EXPORT/IMPORT FILE DOM ELEMENTS (NEW) ==
...
// =========================================================================
// 4. DRAWING / PLACEMENT / MOVEMENT LOGIC
// =========================================================================
...
// =========================================================================
// 5. EXPORT / IMPORT LOGIC (File I/O) (UPDATED & REPAIRED)
// =========================================================================
